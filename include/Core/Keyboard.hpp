...
namespace GFX 
{
    ...
    using KeyboardCharPressEvent = std::function<void(uint32_t codepoint)>;
    using KeyboardKeyDownEvent = std::function<void(KeyCode keycode)>;
    using KeyboardKeyUpEvent = std::function<void(KeyCode keycode)>;
    using KeyboardKeyPressEvent = std::function<void(KeyCode keycode)>;
    using KeyboardKeyRepeatEvent = std::function<void(KeyCode keycode)>;
